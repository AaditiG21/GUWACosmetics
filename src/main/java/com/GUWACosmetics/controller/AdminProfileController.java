 ...
 * This controller handles requests related to the Admin Profile page.
 */
...
public class AdminProfileController extends HttpServlet {
    ...
    /**
     * Handles GET requests for the Admin Profile page.
     * Forwards the request to the AdminProfile.jsp page for rendering.
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Forward the request to the AdminProfile.jsp page
        request.getRequestDispatcher("WEB-INF/pages/AdminProfile.jsp").forward(request, response);
    }

    /**
     * Handles POST requests for the Admin Profile page.
